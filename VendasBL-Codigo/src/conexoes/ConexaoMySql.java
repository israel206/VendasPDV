...
public class ConexaoMySql {
    ...
    private Statement statement; //declaração
    private ResultSet resultSet; //conjunto de resultados


    private String servidor = "localhost";
    private String nomeDoBanco = "dbvenda";
