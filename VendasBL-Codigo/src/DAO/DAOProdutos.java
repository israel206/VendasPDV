...
public class DAOProdutos extends ConexaoMySql {
     ...
     *
     * @param pIdProduto
     * @return boolean(verdadeiro ou false)
     */
    ...
    public ModelProdutos retornarProdutoDAO(int pIdProduto) {
        ...
        try {
            ...
            //Pecorrendo select o ResultSet(conjuto de resultado) colocando modelProdutos
    ...
    public ArrayList<ModelProdutos> retornarListaProdutosDAO() {
        ...
        try {
            ...
            //Pecorrendo select o ResultSet(conjuto de resultado) colocando modelProdutos
            while (this.getResultSet().next()) {
                //zerando o modelproduto e recebendo um novo
    ...
    public boolean alterarEstoqueProdutosDAO(ArrayList<ModelProdutos> pListaModelProdutos) {
        try {
            this.conectar();
            //for, pecorrendo o tamanho da lista
