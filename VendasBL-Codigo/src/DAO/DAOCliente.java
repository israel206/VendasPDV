        ...
        try {
            ...
            return this.insertSQL(
                ...
                + ") VALUES ("
                    ...
                    + "'" + pModelCliente.getCliTelFixo() + "',"
                    + "'" + pModelCliente.getCliTelCel() + "'"
                + ");"
            );
        }catch(Exception e){
            e.printStackTrace();
        ...
        try {
            ...
            return this.executarUpdateDeleteSQL(
                "UPDATE tbl_cliente SET "
                    ...
                    + "cli_zona = '" + pModelCliente.getCliZona() + "',"
                    ...
                    + "cli_tel_fixo = '" + pModelCliente.getCliTelFixo() + "',"
                    + "cli_tel_cel = '" + pModelCliente.getCliTelCel() + "'"
                + " WHERE "
                    + "pk_id_cliente = '" + pModelCliente.getIdCliente() + "'"
                + ";"
            );
